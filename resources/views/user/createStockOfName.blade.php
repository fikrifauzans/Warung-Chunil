...
@section('contain')
    ...
    @else
        <div class="row justify-content-center">
                                            ...
                                            <div class="containter">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input value="" min="0" placeholder='qty' name="qty[]" type="number" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row col-10 justify-content-center my-3">

                <div class="col-lg-5 ">
                    <button type="submit" class="m-0 shadow-lg w-100 btn btn-success">Input</button>
                </div>
            </div>
        </div>
