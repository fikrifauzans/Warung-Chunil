...
@section('contain')
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-md-8 mb-5 bg-light shadow px-5 rounded">
                ...
                <form action="/product/update/{{ $product->id }}/updated" method="post">@csrf
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1"
                            value="{{ $product->category->name }}" name="category">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name='purchase_price' class="form-control" id="formGroupExampleInput"
                            value="{{ $product->purchase_price }}" name="price" placeholder="Contoh: 5000">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name='selling_price' class="form-control" id="formGroupExampleInput"
                            value="{{ $product->selling_price }}" name="price" placeholder="Contoh: 5000">
                    </div>
